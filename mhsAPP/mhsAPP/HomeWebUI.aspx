<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeWebUI.aspx.cs" Inherits="mhsAPP.HomeWebUI" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <div id="container" style="height: 558px; left: 0px; top: 0px;">
...
<div id="g_shape1" style="position:absolute; overflow:hidden; left:16px; top:525px; width:751px; height:15px; z-index:9"><img border=0 width="100%" height="100%" alt="" src="images/shape6501497.gif"/></div>
                <div id="text1" style="position:absolute; overflow:hidden; left:232px; top:219px; width:510px; height:210px; z-index:10">
                    <div class="allfont">
                        <div><font color="#253B6D">Selamat Datang,
                            <asp:Label ID="lblNamaMhs" runat="server"></asp:Label></font></div>
                    </div>
                </div>
