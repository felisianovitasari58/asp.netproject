<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KPWebUI.aspx.cs" Inherits="mhsAPP.KPWebUI" %>
...
<div id="g_shape1" style="position:absolute; overflow:hidden; left:16px; top:750px; width:751px; height:15px; z-index:9"><img border="0px" width="100%" height="100%" alt="" src="images/shape6501497.gif"></div>
                ...
                <asp:Panel ID="Panel1" runat="server" BorderColor="DarkGray" BorderWidth="1px" Height="276px"
                    ...
                    <asp:Button ID="btndaftarKP" runat="server" Style="background-image: url(images/nav38633020a.gif); position: absolute; background-color: transparent; left: 60px; top: 7px;"
                        Text="Daftar KP" BorderStyle="None" Height="26px" Width="125px" OnClick="btndaftarKP_Click" BackColor="White" />
                    </td>
                    </tr>
                    <tr>
                    ...
                    <td align="center" style="height: 28px; width: 67px;" >
                        *</td>
                    <td style="width: 162px; height: 28px">
                        Mahasiswa mengumpulkan form data kerja praktek beserta lampiran yg diwajibkan ke bagian TU yang be<td style="width: 3px">
                    </tr>
                    </table>
                    <table border="0" cellpadding="1" cellspacing="0" style="border-collapse: collapse; left: 279px; position: absolute; top: 4px;" id="Table2" >
                        <tr>
                            <td align="center" colspan="2" style="height: 37px">
                                <asp:Button ID="btndftrujKP" runat="server" Style="background-image: url(images/nav38633020a.gif); position: absolute; background-color: transparent; left: 61px; top: 7px;"
                        Text="Daftar Ujian KP" BorderStyle="None" Height="26px" Width="125px" OnClick="btndftrujKP_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td align="center" style="width: 67px" >
