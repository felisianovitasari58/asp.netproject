<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TAWebUI.aspx.cs" Inherits="mhsAPP.TAWebUI" %>
...
<div id="g_shape1" style="position:absolute; overflow:hidden; left:16px; top:750px; width:751px; height:15px; z-index:9"><img border="0px" width="100%" height="100%" alt="" src="images/shape6501497.gif"></div>
                ...
                <asp:Panel ID="Panel1" runat="server" BorderColor="DarkGray" BorderWidth="1px" Height="276px"
                    Style="left: 231px; position: absolute; top: 399px" Width="530px">
                    <table border="0" cellpadding="1" cellspacing="0" style="border-collapse: collapse; left: 16px; position: absolute; top: 4px;" id="TABLE1" >
                    <tr>
                    <td align="center" colspan="2" style="height: 37px">
                    <asp:Button ID="btndaftarTA" runat="server" Style="background-image: url(images/nav38633020a.gif); position: absolute; background-color: transparent; left: 60px; top: 7px;"
                        Text="Daftar TA" BorderStyle="None" Height="26px" Width="125px" OnClick="btndaftarKP_Click" BackColor="White" />
                    </td>
                    </tr>
                    <tr>
                    ...
                    <td style="width: 162px">
                        Mahasiswa mengisi data kerja praktek yang akan dilaksanakan&nbsp;
                    </td>
                    </tr>
                    <tr>
                    <td align="center" style="height: 28px; width: 67px;" >
                        *</td>
                    <td style="width: 162px; height: 28px">
                        Mahasiswa mencetak form data kerja praktek yang telah didaftarkan</td>
                    </tr>
                    <tr>
                    <td align="center" style="height: 28px; width: 67px;" >
                        *</td>
                    <td style="width: 162px; height: 28px">
                        Mahasiswa mengumpulkan form data kerja praktek beserta lampiran yg diwajibkan ke bagian TU yang bersangkutan</td>
                    </tr>
                    </table>
                    <table border="0" cellpadding="1" cellspacing="0" style="border-collapse: collapse; left: 279px; position: absolute; top: 4px;" id="Table2" >
                        <tr>
                            <td align="center" colspan="2" style="height: 37px">
                                <asp:Button ID="btndftrujTA" runat="server" Style="background-image: url(images/nav38633020a.gif); position: absolute; background-color: transparent; left: 61px; top: 7px;"
                        Text="Daftar Ujian TA" BorderStyle="None" Height="26px" Width="125px" OnClick="btndftrujTA_Click"/>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" style="width: 67px" >
                        ...
                        <tr>
                            <td align="center" style="height: 28px; width: 67px;" >
                                *</td>
                            <td style="width: 162px; height: 28px">
                                Mahasiswa mengumpulkan form data kerja praktek beserta lampiran yg diwajibkan ke
                                bagian TU yang bersangkutan</td>
                            <td>
                            </td>
                        </tr>
                    </table>
                ...
                <asp:Panel ID="Panel2" runat="server" BorderColor="DarkGray" BorderWidth="1px" Height="155px"
                    Style="left: 300px; position: absolute; top: 213px" Width="375px">
                    ...
                    <asp:TextBox ID="txtEmailWTA" runat="server" Enabled="False" Style="left: 134px; position: absolute;
                        top: 93px" Width="203px"></asp:TextBox>
                    <asp:TextBox ID="txthpmhsWTA" runat="server" Enabled="False" Style="left: 134px;
                        position: absolute; top: 119px" Width="203px"></asp:TextBox>
                    <asp:Button ID="btnEditEmail" runat="server" Height="20px" Style="left: 348px;
                        position: absolute; top: 94px; background-color: transparent" Width="18px" OnClick="btnEditEmail_Click" />
                    <asp:Button ID="btnEdHpWKP" runat="server" Height="20px" Style="left: 348px;
                        position: absolute; top: 118px; background-color: transparent" Width="18px" OnClick="btnEdHpWKP_Click" />
                </asp:Panel>
                &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </div>
        </div>
